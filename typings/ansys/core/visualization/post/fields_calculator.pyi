...
class FieldsCalculator:
    ...
    @property
    def expression_names(self): # -> list[Any]:
    ...
    def add_expression(self, calculation, assignment, name=...): # -> Literal[False]:
    ...
    @pyaedt_function_handler()
    def load_expression_file(self, input_file): # -> Dict[Any, Any] | List[Any] | Literal[False]:
    ...
    @pyaedt_function_handler()
    def evaluate(self, expression, setup=..., intrinsics=...): # -> str | None:
