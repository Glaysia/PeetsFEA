...
def post_processor(app=..., project=..., design=..., version=...): # -> PostProcessor3D | PostProcessor3DLayout | PostProcessorCircuit | PostProcessorHFSS | PostProcessorIcepak | PostProcessorMaxwell | None:
    """PostProcessor.
