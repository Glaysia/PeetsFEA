...
class HDMPlotter(CommonPlotter):
    ...
    @property
    def hdm_data(self): # -> Any | complex | list[complex] | list[Any] | tuple[Any, ...] | float | int | NDArray[Any] | list[Any | complex | float | int] | list[Any | complex | list[complex] | list[Any] | tuple[Any, ...] | NDArray[Any] | list[Any | complex | float | int]] | None:
    ...
    @pyaedt_function_handler()
    @graphics_required
    def plot_rays(self, snapshot_path=...):
