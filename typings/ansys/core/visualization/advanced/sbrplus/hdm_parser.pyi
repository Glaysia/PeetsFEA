...
class Parser:
    ...
    def parse_message(self): # -> Any | complex | list[complex] | list[Any] | tuple[Any, ...] | float | int | NDArray[Any] | list[Any | complex | float | int] | list[Any | complex | list[complex] | list[Any] | tuple[Any, ...] | NDArray[Any] | list[Any | complex | float | int]]:
