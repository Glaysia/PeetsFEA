...
class Sim(Parameter) :
    ...
    def create_exctation(self) :
        ...
        Tx_winding = self.M3D.assign_winding(coil_terminals=[], winding_type="Current",is_solid=True,current_value= self.Tx_current,name="Tx")
        Rx_winding = self.M3D.assign_winding(coil_terminals=[], winding_type="Current",is_solid=True,current_value= self.Rx_current,name="Rx1")
