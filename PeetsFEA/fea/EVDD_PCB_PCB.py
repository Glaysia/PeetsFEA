...
if __name__ == "__main__":
    parameters_list = [
        ...
        SimulationInputParameters(
            freq=285.0, input_voltage=105.0, w1=20.0,
            l1_leg=2.0, l1_top=1.2, l2=7.1,
            h1=2.1, l1_center=4.0, Tx_turns=16.0,
            Tx_width=0.187083, Tx_height=0.187083, Tx_space_x=0.1,
            Tx_space_y=0.8, Tx_preg=0.05, Rx_width=4.0,
            Rx_height=0.1, Rx_space_x=0.4, Rx_space_y=0.1,
            Rx_preg=0.09, g2=0.67, Tx_layer_space_x=0.2,
            Tx_layer_space_y=0.3, Tx_current=1.1, Rx_current=1.5,
        ),
        SimulationInputParameters(
            freq=285.0, input_voltage=100.0, w1=20.0,
            l1_leg=2.0, l1_top=1.2, l2=7.2,
            h1=2.1, l1_center=4.0, Tx_turns=17.0,
            Tx_width=0.187083, Tx_height=0.187083, Tx_space_x=0.1,
            Tx_space_y=0.8, Tx_preg=0.05, Rx_width=4.1,
            Rx_height=0.1, Rx_space_x=0.2, Rx_space_y=0.1,
            Rx_preg=0.1, g2=0.69, Tx_layer_space_x=0.2,
            Tx_layer_space_y=0.3, Tx_current=1.1, Rx_current=1.1,
        ),
        SimulationInputParameters(
            freq=282.0, input_voltage=103.0, w1=20.0,
            l1_leg=2.0, l1_top=1.2, l2=7.2,
            h1=2.1, l1_center=4.0, Tx_turns=17.0,
            Tx_width=0.187083, Tx_height=0.187083, Tx_space_x=0.1,
            Tx_space_y=0.8, Tx_preg=0.05, Rx_width=4.1,
            Rx_height=0.1, Rx_space_x=0.3, Rx_space_y=0.1,
            Rx_preg=0.11, g2=0.67, Tx_layer_space_x=0.2,
            Tx_layer_space_y=0.3, Tx_current=1.0, Rx_current=1.3,
        ),
        SimulationInputParameters(
            freq=150.0, input_voltage=400.0, w1=166.0,
            l1_leg=6.2, l1_top=1.1, l2=26.0,
            h1=2.4, l1_center=10.0, Tx_turns=14.0,
            Tx_width=1.0, Tx_height=0.105, Tx_space_x=4.5,
            Tx_space_y=1.4, Tx_preg=0.29, Rx_width=7.0,
            Rx_height=0.14, Rx_space_x=4.1, Rx_space_y=2.6,
            Rx_preg=0.07, g2=1.5, Tx_layer_space_x=4.6,
            Tx_layer_space_y=0.8, Tx_current=4.0, Rx_current=11.0,
        ),
        SimulationInputParameters(
            freq=150.0, input_voltage=400.0, w1=123.0,
            l1_leg=9.9, l1_top=1.1, l2=26.3,
            h1=2.4, l1_center=20.0, Tx_turns=5.0,
            Tx_width=1.0, Tx_height=0.105, Tx_space_x=3.0,
            Tx_space_y=1.6, Tx_preg=0.1, Rx_width=12.0,
            Rx_height=0.175, Rx_space_x=1.7, Rx_space_y=1.3,
            Rx_preg=0.22, g2=0.44, Tx_layer_space_x=4.2,
            Tx_layer_space_y=0.8, Tx_current=4.0, Rx_current=11.0,
        ),
        SimulationInputParameters(
            freq=150.0, input_voltage=400.0, w1=38.0,
            l1_leg=12.4, l1_top=1.1, l2=26.0,
            h1=2.4, l1_center=21.0, Tx_turns=8.0,
            Tx_width=1.1, Tx_height=0.14, Tx_space_x=1.3,
            Tx_space_y=0.7, Tx_preg=0.14, Rx_width=14.0,
            Rx_height=0.035, Rx_space_x=4.0, Rx_space_y=2.2,
            Rx_preg=0.18, g2=1.27, Tx_layer_space_x=3.7,
            Tx_layer_space_y=0.4, Tx_current=4.0, Rx_current=11.0,
        ),
        SimulationInputParameters(
            freq=150.0, input_voltage=400.0, w1=74.0,
            l1_leg=6.6, l1_top=1.1, l2=24.8,
            h1=2.4, l1_center=24.0, Tx_turns=17.0,
            Tx_width=1.0, Tx_height=0.035, Tx_space_x=4.6,
            Tx_space_y=2.0, Tx_preg=0.23, Rx_width=12.0,
            Rx_height=0.14, Rx_space_x=3.5, Rx_space_y=0.5,
            Rx_preg=0.25, g2=1.9, Tx_layer_space_x=4.9,
            Tx_layer_space_y=0.8, Tx_current=4.0, Rx_current=11.0,
        ),
        SimulationInputParameters(
            freq=150.0, input_voltage=400.0, w1=87.0,
            l1_leg=3.7, l1_top=1.1, l2=29.2,
            h1=2.4, l1_center=6.0, Tx_turns=12.0,
            Tx_width=2.2, Tx_height=0.105, Tx_space_x=0.6,
            Tx_space_y=1.3, Tx_preg=0.19, Rx_width=5.0,
            Rx_height=0.175, Rx_space_x=1.0, Rx_space_y=2.8,
            Rx_preg=0.16, g2=0.31, Tx_layer_space_x=2.9,
            Tx_layer_space_y=2.0, Tx_current=4.0, Rx_current=11.0,
        ),
        SimulationInputParameters(
            freq=100.0, input_voltage=400.0, w1=182.0,
            l1_leg=13.8, l1_top=1.1, l2=26.0,
            h1=2.4, l1_center=7.0, Tx_turns=13.0,
            Tx_width=1.0, Tx_height=0.105, Tx_space_x=4.3,
            Tx_space_y=4.4, Tx_preg=0.25, Rx_width=10.0,
            Rx_height=0.07, Rx_space_x=0.9, Rx_space_y=3.1,
            Rx_preg=0.17, g2=2.29, Tx_layer_space_x=3.7,
            Tx_layer_space_y=0.8, Tx_current=4.0, Rx_current=11.0,
        ),
        SimulationInputParameters(
            freq=105.0, input_voltage=400.0, w1=105.0,
            l1_leg=12.0, l1_top=1.1, l2=25.5,
            h1=2.4, l1_center=6.0, Tx_turns=17.0,
            Tx_width=1.0, Tx_height=0.035, Tx_space_x=4.0,
            Tx_space_y=4.5, Tx_preg=0.25, Rx_width=4.0,
            Rx_height=0.175, Rx_space_x=3.9, Rx_space_y=1.3,
            Rx_preg=0.25, g2=2.33, Tx_layer_space_x=2.1,
            Tx_layer_space_y=0.8, Tx_current=4.0, Rx_current=11.0,
        ),
        SimulationInputParameters(
            freq=150.0, input_voltage=400.0, w1=123.0,
            l1_leg=11.1, l1_top=1.2, l2=28.4,
            h1=2.4, l1_center=15.0, Tx_turns=20.0,
            Tx_width=0.9, Tx_height=0.175, Tx_space_x=2.5,
            Tx_space_y=4.1, Tx_preg=0.17, Rx_width=12.0,
            Rx_height=0.07, Rx_space_x=2.5, Rx_space_y=0.5,
            Rx_preg=0.07, g2=1.5, Tx_layer_space_x=4.6,
            Tx_layer_space_y=0.2, Tx_current=4.0, Rx_current=11.0,
        ),
        SimulationInputParameters(
            freq=150.0, input_voltage=400.0, w1=90.0,
            l1_leg=14.5, l1_top=1.1, l2=26.0,
            h1=2.4, l1_center=17.0, Tx_turns=20.0,
            Tx_width=1.0, Tx_height=0.035, Tx_space_x=2.5,
            Tx_space_y=1.3, Tx_preg=0.25, Rx_width=11.0,
            Rx_height=0.105, Rx_space_x=0.4, Rx_space_y=3.2,
            Rx_preg=0.3, g2=1.18, Tx_layer_space_x=2.4,
            Tx_layer_space_y=0.8, Tx_current=4.0, Rx_current=11.0,
        ),
        SimulationInputParameters(
            freq=150.0, input_voltage=400.0, w1=168.0,
            l1_leg=4.6, l1_top=1.1, l2=26.0,
            h1=2.4, l1_center=21.0, Tx_turns=19.0,
            Tx_width=0.9, Tx_height=0.07, Tx_space_x=3.2,
            Tx_space_y=1.9, Tx_preg=0.05, Rx_width=12.0,
            Rx_height=0.035, Rx_space_x=4.2, Rx_space_y=0.5,
            Rx_preg=0.24, g2=1.5, Tx_layer_space_x=3.1,
            Tx_layer_space_y=0.8, Tx_current=4.0, Rx_current=11.0,
        ),
    ]

    selected_idx = 9
    run_simulation(run_simulation=False, use_random=False, input_parameters=parameters_list[selected_idx])
